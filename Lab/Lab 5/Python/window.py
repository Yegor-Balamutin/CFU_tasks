...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        self.text_edit.setPlaceholderText(QCoreApplication.translate("MainWindow",u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0442\u0435\u043a\u0441\u0442...",None))
        self.load_button.setText(QCoreApplication.translate("MainWindow", u"\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435",None))
        self.decode_button.setText(QCoreApplication.translate("MainWindow",u"\u0414\u0435\u043a\u043e\u0434\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0442\u0435\u043a\u0441\u0442",None))
        self.encode_button.setText(QCoreApplication.translate("MainWindow",u"\u041a\u043e\u0434\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0442\u0435\u043a\u0441\u0442",None))
        self.save_button.setText(QCoreApplication.translate("MainWindow",u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435",None))
        pass
...
class MainWindow(QMainWindow):
    ...
    def read_image(self):
        ...
        if not QFile.exists(filepath):
            self.set_output_message("Изображение не найдено!")
            return

        self.image = QImage()
        if not self.image.load(filepath):
            self.set_output_message("Изображение не загружено!")
            self.clear_image()
            return
    ...
    def write_image(self):
        ...
        if self.image.save(filepath, "PNG"):
            self.set_output_message("Изображение успешно сохранено.")
            return
    ...
    def encode_text(self):
        ...
        if self.data.overflow():
            self.set_output_message("Ошибка! Недостаточно места.")
            return
        ...
        self.set_output_message("Сообщение добавлено в картинку.")
    ...
    def message_changed(self):
        ...
        self.set_output_message(f"Размер сообщения превышен.")
